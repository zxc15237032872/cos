...
def calculate_similarity(image_path1, image_path2):
    ...
    try:
        ...
        resultA = calculate_spoke_number5(transform1.copy())
        resultB = calculate_spoke_number5(transform2.copy())
        if resultA!=resultB:
            resultA = calculate_spoke_number6(transform1.copy())
            resultB = calculate_spoke_number6(transform2.copy())
        ...
        if resultA!=resultB:
            resultA=calculate_spoke_number6(g_mask1.copy())
            resultB=calculate_spoke_number6(g_mask2.copy())
        print(resultA, "个辐条")
        ...
        u_times = min(resultA, resultB) // 3 if min(resultA, resultB) <7 else   min(resultA, resultB) // 3-1
        ...
        #     # print("第二次处理1")
        #     # # print(clusteringa.shape)
        #     # clusteringb = extract_ellipse_region(clustering2)
        #
        #     print("第二次处理2")
        #     # print(clusteringb.shape)
        #     print("第二次处理1")
        #
        #
        #     clusteringa = cv2.resize(clustering1, (size, size), interpolation=cv2.INTER_CUBIC)
        #     clusteringb = cv2.resize(clustering2, (size, size), interpolation=cv2.INTER_CUBIC)
        #     print("第二次处理2")
...
image_path1 = "xie5output\\" + image_path1
image_path2 = "xie5output\\" + image_path2
