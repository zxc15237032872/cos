...
def calculate_similarity(image_path1, image_path2):
    ...
    return max_similarity, best_angle, opening_mask1, opening_mask2, best_rotated_mask2, max_val
...
for pair in image_pairs:
    ...
    similarity, best_angle, opening_mask1, opening_mask2, rotated_mask2, template_match_score = calculate_similarity(
